...
QT_MOC_LITERAL(4, 37, 12), // "portsUpdated"
QT_MOC_LITERAL(5, 50, 15), // "handleReadyRead"
QT_MOC_LITERAL(6, 66, 14), // "openSerialPort"
QT_MOC_LITERAL(7, 81, 8), // "portName"
QT_MOC_LITERAL(8, 90, 8), // "baudRate"
QT_MOC_LITERAL(9, 99, 15), // "closeSerialPort"
QT_MOC_LITERAL(10, 115, 14), // "availablePorts"
QT_MOC_LITERAL(11, 130, 9), // "writeData"
QT_MOC_LITERAL(12, 140, 12), // "refreshPorts"
QT_MOC_LITERAL(13, 153, 8), // "filepath"
QT_MOC_LITERAL(14, 162, 4) // "path"

    },
    "SerialPortManager\0dataReceived\0\0data\0"
    "portsUpdated\0handleReadyRead\0"
    "openSerialPort\0portName\0baudRate\0"
    "closeSerialPort\0availablePorts\0writeData\0"
    "refreshPorts\0filepath\0path"
};
...
void SerialPortManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: { bool _r = _t->openSerialPort((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])));
        ...
        case 7: { QStringList _r = _t->refreshPorts();
            if (_a[0]) *reinterpret_cast< QStringList*>(_a[0]) = std::move(_r); }  break;
        case 8: _t->filepath((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialPortManager::portsUpdated)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SerialPortManager::dataReceived(const QString & _t1)
{
...
// SIGNAL 1
void SerialPortManager::portsUpdated()
{
